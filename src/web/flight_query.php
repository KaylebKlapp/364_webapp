        ...
        <div class="formbody">
            <form method="post" class="reserve_form" action="flights.php">
                ...
                <select name="departure" id="departure">
                    ...
                    <option value="Ramstein AB, Rhineland-Palatinate, Germany">Ramstein AB, Rhineland-Palatinate,
                        Germany</option>
                    ...
                    <option value="Aviano AB, Friuli Venezia Giulia, Italy">Aviano AB, Friuli Venezia Giulia, Italy
                    </option>
                </select>
